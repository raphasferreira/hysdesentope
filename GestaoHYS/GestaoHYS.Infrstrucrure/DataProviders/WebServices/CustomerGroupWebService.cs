...
{
    public class CustomerGroupWebService : ICustomerGroupWebService
    {
        private ICustomerGroupClient _client;

        public CustomerGroupWebService(ICustomerGroupClient client)
        {
            _client = client;
        ...
        public async Task<IList<CustomerGroup>> GetAll()
        {
            try
            {
            ...
            {
                throw new Exception($"Erro ao buscar todos as grupos do cliente. { ex.Message } ");
            }
        }
    }
}
