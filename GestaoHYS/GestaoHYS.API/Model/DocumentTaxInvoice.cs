...
{
    public class DocumentTaxInvoice
    {
        //[Column("version")]
        ...
        [Column("customExemptionReasonCode")]
        public string CustomExemptionReasonCode { get; set; }

        [Column("customExemptionReasonCodeId")]
        public string CustomExemptionReasonCodeId { get; set; }

        [Column("customExemptionReasonCodeDescription")]
        public string CustomExemptionReasonCodeDescription { get; set; }
