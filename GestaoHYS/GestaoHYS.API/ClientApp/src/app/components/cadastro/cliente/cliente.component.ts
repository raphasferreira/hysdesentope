...
export class ClienteComponent implements OnInit {
  ...
  createCliente() {
    this.dialog.open(ClienteCreateUpdateComponent).afterClosed().subscribe((cliente: Cliente) => {
      /**
       * Cliente is the updated customer (if the user pressed Save - otherwise it's null)
       */
      if (cliente) {
        /**
         ...
         */
        this.clientes.unshift(new Cliente(cliente));
        this.subject$.next(this.clientes);
      }
    });
  }
