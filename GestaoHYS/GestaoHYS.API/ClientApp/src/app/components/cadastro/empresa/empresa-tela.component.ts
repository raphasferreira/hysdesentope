...
@Component({
  selector: 'vex-empresa-tela',
  templateUrl: './empresa-tela.component.html',
  //styleUrls: ['./empresa-tela.component.scss']
  animations: [
    stagger40ms,
    scaleIn400ms,
    fadeInRight400ms,
...
export class EmpresaTelaComponent implements OnInit {

  labelBotao:string='Criar Empresa';
  ...
  trocarTela(){
    this.labelBotao = this.labelBotao=='Criar Empresa'?'Voltar Lista':'Criar Empresa';
